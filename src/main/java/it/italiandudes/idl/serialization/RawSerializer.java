 ...
 */
package it.italiandudes.idl.serialization;

import it.italiandudes.idl.common.FormattedImage;
import it.italiandudes.idl.throwable.exceptions.IO.socket.CorruptedImageException;
import it.italiandudes.idl.throwable.exceptions.IO.socket.InputStreamReadException;
import it.italiandudes.idl.throwable.exceptions.IO.socket.OutputStreamWriteException;
import it.italiandudes.idl.throwable.exceptions.IO.socket.SpecializedStreamInstancingException;
import it.italiandudes.idl.handler.FileHandler;
